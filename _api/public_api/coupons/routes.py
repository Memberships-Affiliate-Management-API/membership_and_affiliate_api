...
from views import coupons_view
...
def coupons(path: str) -> tuple:
    ...
    if path == "get":
        return coupons_view.get_coupon(coupon_data=coupon_data)
    elif path == "create":
        return coupons_view.add_coupon(coupon_data=coupon_data)
    elif path == "update":
        return coupons_view.update_coupon(coupon_data=coupon_data)
    elif path == "cancel":
        return coupons_view.cancel_coupon(coupon_data=coupon_data)
    elif path == "get-all":
        organization_id: Optional[str] = coupon_data.get('organization_id')
        return coupons_view.get_all_coupons(organization_id=organization_id)
    elif path == "get-valid":
        organization_id: Optional[str] = coupon_data.get('organization_id')
        return coupons_view.get_valid_coupons(organization_id=organization_id)
    elif path == "get-expired":
        organization_id: Optional[str] = coupon_data.get('organization_id')
        return coupons_view.get_expired_coupons(organization_id=organization_id)
    else:
        pass
